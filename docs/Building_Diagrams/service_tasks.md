...
### Example 1: Retrieving Employee Information from BambooHR API
...
- **Operator ID**: `http/GetRequestV2`
  - This operator variant provides additional options for configuring HTTP requests.
- **Response Variable**: `resp_get_post_1`
