...
Lanes are used in a BPMN diagram to organize aspects of a process.
They visually group objects, with each aspect of the process added to a separate lane.

These elements can be arranged either horizontally or vertically.
Not only do lanes organize activities into separate categories, but they can also reveal delays, inefficiencies, and the individuals responsible for each step in a process.
