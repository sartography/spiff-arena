...
For complete examples of the proper request and response formats, see the [Connector Proxy API Examples](../../reference/connector_proxy_examples) reference page.
