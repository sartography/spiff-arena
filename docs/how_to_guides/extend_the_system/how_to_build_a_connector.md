...
Connectors are custom integrations that run within Spiff Arena's [Connector Proxy](../../explanation/dev/connector_proxy) architecture to interact with external systems. The Connector Proxy provides a secure, scalable way to handle these integrations.
