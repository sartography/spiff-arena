        ...
        app.config["SPIFFWORKFLOW_BACKEND_AUTH_CONFIGS"] = [
            {
                ...
                "logout_redirect_uri_parameter": app.config.get("SPIFFWORKFLOW_BACKEND_OPEN_ID_LOGOUT_REDIRECT_URI_PARAMETER"),
                "logout_include_client_id": app.config.get("SPIFFWORKFLOW_BACKEND_OPEN_ID_LOGOUT_INCLUDE_CLIENT_ID"),
                "logout_include_id_token_hint": app.config.get("SPIFFWORKFLOW_BACKEND_OPEN_ID_LOGOUT_INCLUDE_ID_TOKEN_HINT"),
