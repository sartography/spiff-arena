...
SPIFFWORKFLOW_BACKEND_BACKGROUND_SCHEDULER_POLLING_INTERVAL_IN_SECONDS = int(
    environ.get("SPIFFWORKFLOW_BACKEND_BACKGROUND_SCHEDULER_POLLING_INTERVAL_IN_SECONDS", default="10")
)
...
SPIFFWORKFLOW_BACKEND_ENGINE_STEP_STRATEGY_BACKGROUND = environ.get(
    "SPIFFWORKFLOW_BACKEND_ENGINE_STEP_STRATEGY_BACKGROUND", default="greedy"
)

SPIFFWORKFLOW_BACKEND_ENGINE_STEP_STRATEGY_WEB = environ.get(
    "SPIFFWORKFLOW_BACKEND_ENGINE_STEP_STRATEGY_WEB", default="greedy"
)
