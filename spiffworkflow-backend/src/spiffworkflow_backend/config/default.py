...
config_from_env("OPEN_API_SECRET_KEY", default='')
config_from_env("SPIFFWORKFLOW_BACKEND_BPMN_SPEC_ABSOLUTE_DIR")

### AI Tools
config_from_env("SPIFFWORKFLOW_SCRIPT_ASSIST_ENABLED", default=False)
config_from_env("SECRET_KEY_OPENAI_API", default='')
