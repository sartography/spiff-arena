...
class MessageInstanceModel(SpiffworkflowBaseDBModel):
    ...
    message_instance_identifier: str = db.Column(db.String(255), nullable=True, index=True)
    expires_at_in_seconds: int = db.Column(db.Integer, nullable=True, index=True)
