...
def _process_data_fetcher(
    ...
    if download_file_data and isinstance(process_data_value, str) and process_data_value.startswith("data:"):
...
def process_data_show(
    ...
    """Process_data_show."""
    return _process_data_fetcher(process_instance_id, process_data_identifier, modified_process_model_identifier, False, None)
...
def process_data_file_download(
    ...
    return _process_data_fetcher(process_instance_id, process_data_identifier, modified_process_model_identifier, True, index)
