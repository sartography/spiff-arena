...
"""
            ...
            # 4. Configure both BPMN spec directory and enable global scripts for this test
            ...
            with self.app_config_mock(app, "SPIFFWORKFLOW_BACKEND_BPMN_SPEC_ABSOLUTE_DIR", tmp_dir):
                with self.app_config_mock(app, "SPIFFWORKFLOW_BACKEND_GLOBAL_SCRIPTS_DIR_NAME", "global-scripts"):
                    ...
                    # Since SCRIPT_SUB_CLASSES is a global in script.py,
                    # we can modify it via the class method or direct access if imported.
                    # Script.SCRIPT_SUB_CLASSES is not directly exposed as a public attribute to set,
                    # but we can set the module level variable.
