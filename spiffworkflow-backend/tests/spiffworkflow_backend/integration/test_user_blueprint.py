...
#
#
# def test_acceptance(client: TestClient) -> None:
#     """Test_acceptance."""
#     # Create a user U
...
#
#
# def test_user_can_be_created_and_deleted(client: TestClient) -> None:
...
#
#
# def test_delete_returns_an_error_if_user_is_not_found(client: TestClient) -> None:
...
#
#
# def test_create_returns_an_error_if_user_exists(client: TestClient) -> None:
...
#
#
# def test_group_can_be_created_and_deleted(client: TestClient) -> None:
...
#
#
# def test_delete_returns_an_error_if_group_is_not_found(client: TestClient) -> None:
...
#
#
# def test_create_returns_an_error_if_group_exists(client: TestClient) -> None:
...
#
#
# def test_user_can_be_assigned_to_a_group(client: TestClient) -> None:
...
#
#
# def test_user_can_be_removed_from_a_group(client: TestClient) -> None:
...
#
#
# def create_user(client: TestClient, username: str) -> Any:
#     """Create_user."""
#     response = client.get(f"/user/{username}")
#     assert response.status_code == 201
#     user = UserModel.query.filter_by(username=username).first()
...
#
#
# def delete_user(client: TestClient, username: str) -> None:
#     """Delete_user."""
#     response = client.delete(f"/user/{username}")
#     assert response.status_code == 204
#     user = UserModel.query.filter_by(username=username).first()
...
#
#
# def create_group(client: TestClient, group_name: str) -> Any:
#     """Create_group."""
#     response = client.get(f"/group/{group_name}")
#     assert response.status_code == 201
#     group = GroupModel.query.filter_by(name=group_name).first()
...
#
#
# def delete_group(client: TestClient, group_name: str) -> None:
#     """Delete_group."""
#     response = client.delete(f"/group/{group_name}")
#     assert response.status_code == 204
#     group = GroupModel.query.filter_by(name=group_name).first()
...
#     client: TestClient, user: UserModel, group: GroupModel
# ) -> None:
