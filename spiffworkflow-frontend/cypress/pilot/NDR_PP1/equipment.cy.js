const submitWithUser = (
  ...
  if (approvaltype === 'approve') {
    ...
    cy.get('.cds--text-area__wrapper')
      ...
      .type(
        username.concat(
          ' needs additional info. By contrast, software is the set of instructions that can be stored and run by hardware. Hardware is so-termed because it is "hard" or rigid with respect to changes, whereas software is "soft" END.'
        )
      );
    ...
    cy.get('.cds--text-area__wrapper')
      .find('#root')
      .type(username.concat(' is escalating to Budget owner.'));
    ...
    cy.get('.cds--text-area__wrapper')
      ...
      .clear()
      .type(
        'Providing additional info. Computer hardware includes the physical parts of a computer, such as the case, central processing unit (CPU), random access memory (RAM), monitor, mouse, keyboard, computer data storage, graphics card, sound card'
      );
 ...
 */
        ...
        cy.get('#root_item_1_item_name')
          .clear()
          .type(
            'A mainframe computer is a much larger computer that typically fills a room and may cost many hundred'
          );
        ...
        cy.get('#root_item_2_item_name')
          .clear()
          .type(
            'A supercomputer is superficially similar to a mainframe but is instead intended for extremely demand'
          );
        ...
        cy.get('.cds--text-area__wrapper')
          .find('#root')
          .type(
            'The template for all modern computers is the Von Neumann architecture, detailed in a 1945 paper by Hungarian mathematician John von Neumann. This describes a design architecture for a electronic digital computer with subdivisions of a processing unit'
          );
    ...
    it('Out of Policy. People Ops Partner Group approves and Budget owner rejects', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'Electronic appliances and services related to the personal computer, including the PC (desktop or laptop), and communication between computers and the services required by intercommunication networks. These fundamentally include'
          );
 ...
 */
        ...
        cy.get('.cds--text-area__wrapper')
          .find('#root')
          .type(
            'When using computer hardware, an upgrade means adding new or additional hardware to a computer that improves its performance, increases its capacity, or adds new features. For example, \nhttps://en.wikipedia.org/wiki/Computer_hardware'
          );
 ...
 */
        ...
        cy.get('#root_item_0_item_name')
          .clear()
          .type(
            'Rather it indicates the fastest computations available at any given time. In mid-2011, the fastest'
          );
        ...
        cy.get('.cds--text-area__wrapper')
          .find('#root')
          .type(
            'A supercomputer is superficially similar to a mainframe but is instead intended for extremely demanding computational tasks. As of November 2021, the fastest supercomputer on the TOP500 supercomputer list is Fugaku, in Japan'
          );
 ...
 */
        ...
        cy.get('.cds--text-area__wrapper')
          .find('#root')
          .type(
            'Computer hardware contain dangerous chemicals such as lead, mercury, nickel, and cadmium. According to the EPA these e-wastes have a harmful effect on the environment unless they are disposed properly. \nhttps://en.wikipedia.org/wiki/Computer_hardware'
          );
 ...
 */
        ...
        cy.get('#root_item_0_item_name')
          .clear()
          .type(
            'Computer components contain many toxic substances, like dioxins, polychlorinated biphenyls (PCBs)'
          );
        cy.get('#root_item_0_qty').clear().type('2');
        cy.get('#root_item_0_currency_type').select('Fiat');
    ...
    it('Within Policy. People Ops Partner Group needs more info', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'The personal computer is one of the most common types of computer due to its versatility and relatively low price. Desktop personal computers have a monitor, a keyboard, a mouse, and a computer case. The computer case holds the motherboard'
          );
        cy.get('#root_criticality').select('High');
        cy.get('#root_period').clear().type('05-11-2025');
        cy.get('body').click();
    ...
    it('Within Policy. People Ops Partner Group and Budget owner approves', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'Laptops are designed for portability but operate similarly to desktop PCs.[5] They may use lower-power or reduced size components, with lower performance than a similarly priced desktop computer'
          );
        cy.get('#root_criticality').select('High');
        cy.get('#root_period').clear().type('25-11-2025');
        cy.get('body').click();
    ...
    it('Within Policy. People Ops Partner Group approves and Budget owner rejects', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'The computer case encloses most of the components of the system. It provides mechanical support and protection for internal elements such as the motherboard, disk drives, and power supplies, and controls and directs the flow of cooling air over int. '
          );
        cy.get('#root_criticality').select('Medium');
 ...
 */
        ...
        cy.get('.cds--text-area__wrapper')
          .find('#root')
          .type(
            'The personal computer is one of the most common types of computer due to its versatility and relatively low price. Desktop personal computers have a monitor, a keyboard, a mouse, and a computer case.\nhttps://en.wikipedia.org/wiki/Computer_hardware'
          );
    ...
    it.only('Within Policy. People Ops Partner Group approves and Budget owner needs more info', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'The motherboard is the main component of a computer. It is a board with integrated circuitry that connects the other parts of the computer including the CPU, the RAM, the disk drives (CD, DVD, hard disk, or any others) as well as any peripherals'
          );
        cy.get('#root_criticality').select('Low');
 ...
 */
        ...
        cy.get('#root_item_0_item_name')
          .clear()
          .type(
            'When using computer hardware, an upgrade means adding new or additional hardware to a computer that'
          );
        cy.get('#root_item_0_qty').clear().type('2');
        cy.get('#root_item_0_currency_type').select('Fiat');
        cy.get('#root_item_0_currency').select('AUD');
    ...
    it('Within Policy. People Ops Partner Group approves', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'An expansion card in computing is a printed circuit board that can be inserted into an expansion slot of a computer motherboard or backplane to add functionality to a computer system via the expansion bus. Expansion cards can be used to obtain'
          );
        cy.get('#root_criticality').select('High');
        cy.get('#root_period').clear().type('15-11-2025');
        cy.get('body').click();
    ...
    it('Within Policy. People Ops Partner Group rejects', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'Storage device is any computing hardware and digital media that is used for storing, porting and extracting data files and objects. It can hold and store information both temporarily and permanently and can be internal or external to a computer.'
          );
        cy.get('#root_criticality').select('High');
 ...
 */
        ...
        cy.get('#root_item_0_item_name')
          .clear()
          .type(
            'The central processing unit contains many toxic materials. It contains lead and chromium in metal'
          );
        cy.get('#root_item_0_qty').clear().type('2');
        cy.get('#root_item_0_currency_type').select('Fiat');
    ...
    it('Within Policy. People Ops Partner Group needs more info', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'Data is stored by a computer using a variety of media. Hard disk drives (HDDs) are found in virtually all older computers, due to their high capacity and low cost, but solid-state drives (SSDs) are faster and more power efficient.'
          );
        cy.get('#root_criticality').select('High');
 ...
 */
        ...
        cy.get('#root_item_0_item_name')
          .clear()
          .type(
            'Data is stored by a computer using a variety of media. Hard disk drives (HDDs) are found'
          );
        cy.get('#root_item_0_qty').clear().type('2');
        cy.get('#root_item_0_currency_type').select('Fiat');
    ...
    it('Within Policy. People Ops Partner Group and Budget owner approves', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'To transfer data between computers, an external flash memory device (such as a memory card or USB flash drive) or optical disc (such as a CD-ROM, DVD-ROM or BD-ROM) may be used. '
          );
        cy.get('#root_criticality').select('High');
    ...
    it('Within Policy. People Ops Partner Group approves and Budget owner needs more info', () => {
      ...
      cy.url().then((currentUrl) => {
        ...
        cy.get('#root_purpose')
          .clear()
          .type(
            'Input devices allow the user to enter information into the system, or control its operation. Most personal computers have a mouse and keyboard, but laptop systems typically use a touchpad instead of a mouse. Other input devices include webcams, mic'
          );
        cy.get('#root_criticality').select('Low');
