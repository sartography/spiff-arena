const submitWithUser = (
  ...
  if (approvaltype === 'approve') {
    ...
    cy.get('.cds--text-area__wrapper')
      .find('#root')
      .type(username.concat(' is selecting CP is Approved.'));
    ...
    cy.get('.cds--text-area__wrapper')
      ...
      .clear()
      .type(
        'Providing additional info. Open source is a term that originally referred to open source software (OSS). Open source software is code that is designed to be publicly accessible—anyone can see, modify, and distribute.'
      );
